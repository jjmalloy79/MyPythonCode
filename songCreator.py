...
verse1 = Epic.get_input("Enter the first verse:").upper()
verse2 = Epic.get_input("Enter the second verse:").upper()
verse3 = Epic.get_input("Enter the third verse:").upper()
verse4 = Epic.get_input("Enter the forth verse:").upper()
chorus = Epic.get_input("Enter the chorus:").lower()
...
chorus = Epic.remove_cookie(chorus)
